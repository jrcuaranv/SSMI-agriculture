...
class SemanticPclGenerator:
    ...
    def generate_cloud_semantic(self, bgr_img, semantic_color, depth_img, stamp):
        ...
        # np.savetxt('/home/jose/b.txt', semantic_color[:,:,0])
        # np.savetxt('/home/jose/g.txt', semantic_color[:,:,1])
        # np.savetxt('/home/jose/r.txt', semantic_color[:,:,2])
        # Concatenate data
